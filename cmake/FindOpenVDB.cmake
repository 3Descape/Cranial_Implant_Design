...
foreach(COMPONENT ${OpenVDB_FIND_COMPONENTS})
  ...
  if(${COMPONENT} STREQUAL "openvdb")
    ...
    if(WIN32)
    find_path(OpenVDB_${COMPONENT}_DLL_DIR openvdb.dll
      ${_FIND_OPENVDB_ADDITIONAL_OPTIONS}
      PATHS ${_VDB_COMPONENT_SEARCH_DIRS}
      PATH_SUFFIXES
    ...
    find_path(OpenVDB_${COMPONENT}_DLL_DEBUG_DIR openvdb_debug.dll
      ${_FIND_OPENVDB_ADDITIONAL_OPTIONS}
      PATHS ${_VDB_COMPONENT_SEARCH_DIRS}
      PATH_SUFFIXES
        ${CMAKE_INSTALL_BINDIR}
    ...
    cmake_print_variables(_VDB_COMPONENT_SEARCH_DIRS)
    cmake_print_variables(OpenVDB_${COMPONENT}_DLL_DIR)
    endif()
...
foreach(COMPONENT ${OpenVDB_FIND_COMPONENTS})
  ...
  elseif(${COMPONENT} STREQUAL "openvdb_je")
    ...
    find_library(OpenVDB_${COMPONENT}_LIBRARY ${LIB_NAME}
     ...
     if(${COMPONENT} STREQUAL "openvdb")
        find_library(OpenVDB_${COMPONENT}_DEBUG_LIBRARY "${LIB_NAME}_debug"
            ${_FIND_OPENVDB_ADDITIONAL_OPTIONS}
            PATHS ${_VDB_COMPONENT_SEARCH_DIRS}
            PATH_SUFFIXES ${OPENVDB_LIB_PATH_SUFFIXES}
        )
...
if(NOT TARGET OpenVDB::openvdb)
  ...
  set(OPENVDB_IMP_LIB "${OpenVDB_openvdb_LIBRARY}")
  set(OPENVDB_IMP_LIB_DEBUG "${OpenVDB_openvdb_LIBRARY}")
  set(OPENVDB_IMP_LOC "${OpenVDB_openvdb_LIBRARY}")
  set(OPENVDB_IMP_LOC_DEBUG "${OpenVDB_openvdb_LIBRARY}")
  if(OPENVDB_USE_STATIC_LIBS)
  ...
  elseif(WIN32)
    if(OPENVDB_DLL IN_LIST OpenVDB_DEFINITIONS)
      set(OPENVDB_openvdb_LIB_TYPE SHARED)
      set(OPENVDB_IMP_LIB "${OpenVDB_openvdb_LIBRARY}")
      set(OPENVDB_IMP_LIB_DEBUG "${OpenVDB_openvdb_DEBUG_LIBRARY}")
      set(OPENVDB_IMP_LOC "${OpenVDB_openvdb_DLL_DIR}/openvdb.dll")
      set(OPENVDB_IMP_LOC_DEBUG "${OpenVDB_openvdb_DLL_DIR}/openvdb_debug.dll")
      # cmake_print_variables(OpenVDB_openvdb_DLL_DIR)
      # cmake_print_variables(OPENVDB_IMP_LIB)
      # cmake_print_variables(OPENVDB_IMP_LOC)
    endif()
  endif()

  add_library(OpenVDB::openvdb ${OPENVDB_openvdb_LIB_TYPE} IMPORTED)
  set_target_properties(OpenVDB::openvdb PROPERTIES
    IMPORTED_IMPLIB "${OPENVDB_IMP_LIB}"
    IMPORTED_IMPLIB_DEBUG "${OPENVDB_IMP_LIB_DEBUG}"
    IMPORTED_LOCATION "${OPENVDB_IMP_LOC}"
    IMPORTED_LOCATION_DEBUG "${OPENVDB_IMP_LOC_DEBUG}"
