...
elseif(WIN32)
  set(BLOSC_LIB_TYPE SHARED)
  get_filename_component(_blosc_base_name ${Blosc_LIBRARY} NAME_WE)
  cmake_print_variables(_blosc_base_name)
  find_file(BLOSC_DLL "${_blosc_base_name}.dll"
    PATHS ${Blosc_LIBRARY_DIRS} ${Blosc_LIBRARY_DIRS}/../bin REQUIRED)
  unset(_blosc_base_name)

  cmake_print_variables(BLOSC_DLL)
endif()
...
if(NOT TARGET Blosc::blosc)
  ...
  if(WIN32 AND ${BLOSC_LIB_TYPE} STREQUAL SHARED)
    set_target_properties(Blosc::blosc PROPERTIES
      IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
      IMPORTED_LOCATION "${BLOSC_DLL}"
      IMPORTED_IMPLIB "${Blosc_LIBRARY}")

      message(STATUS "Blosc: Windows using DLLs")
  else()
    set_target_properties(Blosc::blosc PROPERTIES
      IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
  ...
  if(EXISTS "${Blosc_LIBRARY_DEBUG}")
    ...
    set_target_properties(Blosc::blosc PROPERTIES
      ...
      IMPORTED_IMPLIB_DEBUG "${Blosc_LIBRARY_DEBUG}"
      IMPORTED_LOCATION_DEBUG "${BLOSC_DLL}")
  endif()
